[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32m53x-cmake-vscode)](https://github.com/burakenez/gd32m53x-cmake-vscode/tags/)

# GD32M53x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32M53x Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32M53x Demo Suites V1.0.1](https://www.gd32mcu.com/en/download)_** and **_[GD32M53x Firmware Library V1.0.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32m53x-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32M53x**
- **Version:** `V1.0.0 (2026-03-04)`
- **Path:** `Drivers/CMSIS/GD/GD32M53x`
- **Source:** `GD32M53x Demo Suites V1.0.1`

### 3. **GD32M53x_standard_peripheral**
- **Version:** `V1.0.0 (2026-03-04)`
- **Path:** `Drivers/GD32M53x_standard_peripheral`
- **Source:** `GD32M53x Demo Suites V1.0.1`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32m53x_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32m53x_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32m53x_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32m53x.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32m53x.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32M531C_START              # Board support package for GD32M531C_START
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32M53x
│           │   └── GD32M53x_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32m53x_flash.ld  # Linker script (memory regions)
│           └── GD32M53x.svd             # SVD file for peripheral register views
